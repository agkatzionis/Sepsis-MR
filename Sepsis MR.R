...
## cardiometabolic traits and sepsis risk, using 
## data from the UK Biobank and the HUNT study.
...
## The variant rs4836133 is triallelic in the Biobank data for BMI.
## We manually discard the allele that does not appear in the G-X dataset.
sepsis.ukbb.bmi[355:356, ]
bmi1[355, ]
sepsis.ukbb.bmi <- sepsis.ukbb.bmi[-356, ]

## Likewise for variant rs78896587 in the Biobank data for T2DM.
sepsis.ukbb.t2d[186:187, ]
t2dm1[186, ]
sepsis.ukbb.t2d <- sepsis.ukbb.t2d[-186, ]
...
## Do the plot.
tiff(file = "Sepsis_IVW.tiff", width = 1800, height = 1200, pointsize = 11, res = 300, compression = 'lzw')
par(mar = c(4, 7, 2, 10))
...
## Start plotting.
tiff(file = "Sepsis_All_Methods.tiff", width = 2800, height = 1600, pointsize = 10, res = 300, compression = 'lzw')
...
## Create the Figure.
tiff(file = "Sepsis_MVMR_Lipids.tiff", width = 2400, height = 800, pointsize = 11, res = 300, compression = 'lzw')
